...
def getQCDShape(base_path, year, sample_list):
    ...
    f_qcd = TFile.Open(os.path.join(input_path, "hist_dataDrivenQCD.root"), "recreate")
    f_muon = TFile.Open(os.path.join(input_path, "hist_dataDrivenQCD_DataSingleMu.root"))
    f_elec = TFile.Open(os.path.join(input_path, "hist_dataDrivenQCD_DataSingleEG.root"))
    ...
    for proc in sample_list:
        f_tmp = TFile.Open(os.path.join(input_path, "hist_dataDrivenQCD_"+proc+".root"))
        samples[proc] = f_tmp
